...
router.get("/productList/productCategory",function(req,res)
 {
   ...
   let price=req.query.minprice ? req.query.minprice :0
   let Brand=req.query.BND=="NOBRAND" ? "'NOBRAND'"   : req.query.BND 
headProduct=`SELECT id, (SELECT COUNT(*) from products where (select COUNT(*) from headproduct where headproduct.productid=products.id and  headproduct.Headid=1) and  IF   ("${Brand}"="'NOBRAND'" , (select COUNT(*) from headproduct where headproduct.productid=products.id and  headproduct.Headid=1),Brand in (${Brand})   ) and   products.sellingPrice BETWEEN ${req.query.minprice ? req.query.minprice : 0} AND ${req.query.maxprice ? req.query.maxprice :5000000000000000} and products.salesPrice  BETWEEN ${req.query.minprice ? req.query.minprice : 0} AND ${req.query.maxprice ? req.query.maxprice :5000000000000000} ) as count, name,(SELECT MAX(sellingPrice) from products where  (select COUNT(*) from headproduct where headproduct.productid=products.id and  headproduct.Headid=1) )as MaxsellingPrice,(SELECT MAX(salesPrice) from products where  (select COUNT(*) from headproduct where headproduct.productid=products.id and  headproduct.Headid=1) )as MaxsalesPrice,salesPrice,mrp,warranty,qty as maxqty,Brand,HSN_code,Tax,category,Description,variantid,(SELECT IF ((SELECT EXISTS(SELECT * FROM productimage WHERE imagePosition = 1 and productimage.productId = products.id) as result) = 1 , (SELECT image FROM productimage WHERE imagePosition = 1 AND productimage.productId = products.id) , (SELECT image FROM productimage WHERE productimage.productId = products.id LIMIT 1) )  ) as image from products where (select COUNT(*) from headproduct where headproduct.productid=products.id and  headproduct.Headid=1) and  IF   ("${Brand}"="'NOBRAND'" ,  (select COUNT(*) from headproduct where headproduct.productid=products.id and  headproduct.Headid=1),Brand in (${Brand})   ) and   products.sellingPrice BETWEEN ${req.query.minprice ? req.query.minprice : 0} AND ${req.query.maxprice ? req.query.maxprice :5000000000000000} and products.salesPrice  BETWEEN ${req.query.minprice ? req.query.minprice : 0} AND ${req.query.maxprice ? req.query.maxprice :5000000000000000}  ORDER BY ${sortColumn} ${sort} LIMIT ${(req.query.PageNo ? +req.query.PageNo-1 : 1) * 10}, 20 `
...
router.get("/productList/Brand",function(req,res)
 { 
  ...
  viewBrandProduct=`SELECT id, (SELECT COUNT(*) from products where products.Brand="${req.query.Brand}" and  IF   ("${Brand}"="'NOBRAND'" , products.Brand="${req.query.Brand}" ,Brand in (${Brand})   ) and   products.sellingPrice BETWEEN ${req.query.minprice ? req.query.minprice : 0} AND ${req.query.maxprice ? req.query.maxprice :5000000000000000} and products.salesPrice  BETWEEN ${req.query.minprice ? req.query.minprice : 0} AND ${req.query.maxprice ? req.query.maxprice :5000000000000000} ) as count, name,(SELECT MAX(sellingPrice) from products where  products.Brand="${req.query.Brand}" )as MaxsellingPrice,(SELECT MAX(salesPrice) from products where  products.Brand="${req.query.Brand}" )as MaxsalesPrice,salesPrice,mrp,warranty,qty as maxqty,Brand,HSN_code,Tax,category,Description,variantid,(SELECT IF ((SELECT EXISTS(SELECT * FROM productimage WHERE imagePosition = 1 and productimage.productId = products.id) as result) = 1 , (SELECT image FROM productimage WHERE imagePosition = 1 AND productimage.productId = products.id) , (SELECT image FROM productimage WHERE productimage.productId = products.id LIMIT 1) )  ) as image from products where  products.Brand="${req.query.Brand}" and  IF   ("${Brand}"="'NOBRAND'" ,  products.Brand="${req.query.Brand}",Brand in (${Brand})   ) and   products.sellingPrice BETWEEN ${req.query.minprice ? req.query.minprice : 0} AND ${req.query.maxprice ? req.query.maxprice :5000000000000000} and products.salesPrice  BETWEEN ${req.query.minprice ? req.query.minprice : 0} AND ${req.query.maxprice ? req.query.maxprice :5000000000000000}  ORDER BY ${sortColumn} ${sort} LIMIT ${(req.query.PageNo ? +req.query.PageNo-1 : 1) * 10}, 20 `
...
router.get("/productList/searchitem",function(req,res)
 { 
  ...
  let price=req.query.minprice ? req.query.minprice :0
  let Brand=req.query.BND=="NOBRAND" ? "'NOBRAND'"   : req.query.BND 
  viewSearchProduct=`SELECT id, (SELECT COUNT(*) from products where  name LIKE N'%${req.query.searchitem}%' and  IF   ("${Brand}"="'NOBRAND'" , category='${req.query.category}' ,Brand in (${Brand})   ) and   products.sellingPrice BETWEEN ${req.query.minprice ? req.query.minprice : 0} AND ${req.query.maxprice ? req.query.maxprice :5000000000000000} and products.salesPrice  BETWEEN ${req.query.minprice ? req.query.minprice : 0} AND ${req.query.maxprice ? req.query.maxprice :5000000000000000} ) as count, name,(SELECT MAX(sellingPrice) from products where  name LIKE N'%${req.query.searchitem}%' )as MaxsellingPrice,(SELECT MAX(salesPrice) from products where  name LIKE N'%${req.query.searchitem}%' )as MaxsalesPrice,salesPrice,mrp,warranty,qty as maxqty,Brand,HSN_code,Tax,category,Description,variantid,(SELECT IF ((SELECT EXISTS(SELECT * FROM productimage WHERE imagePosition = 1 and productimage.productId = products.id) as result) = 1 , (SELECT image FROM productimage WHERE imagePosition = 1 AND productimage.productId = products.id) , (SELECT image FROM productimage WHERE productimage.productId = products.id LIMIT 1) )  ) as image from products where  name LIKE N'%${req.query.searchitem}%' and  IF   ("${Brand}"="'NOBRAND'" ,  name LIKE N'%${req.query.searchitem}%',Brand in (${Brand})   ) and   products.sellingPrice BETWEEN ${req.query.minprice ? req.query.minprice : 0} AND ${req.query.maxprice ? req.query.maxprice :5000000000000000} and products.salesPrice  BETWEEN ${req.query.minprice ? req.query.minprice : 0} AND ${req.query.maxprice ? req.query.maxprice :5000000000000000}  ORDER BY ${sortColumn} ${sort} LIMIT ${(req.query.PageNo ? +req.query.PageNo-1 : 1) * 10}, 20 `
